package com.why.profiles.view;

import java.util.Calendar;
import java.util.Locale;

import com.why.profiles.R;
import com.why.profiles.adapter.ScheduleCalendarAdapter;
...
public class ExtendedCalendarView extends RelativeLayout implements
	...
	private void init() {
		...
		prev.setImageResource(R.drawable.schedule_navigation_previous_item);
		...
		next.setImageResource(R.drawable.schedule_navigation_next_item);
		...
		mAdapter = new ScheduleCalendarAdapter(context, cal);
