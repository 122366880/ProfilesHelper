...
import com.why.profiles.model.Day;
...
public class ScheduleCalendarAdapter extends BaseAdapter {
	...
	public ScheduleCalendarAdapter(Context context, Calendar cal) {
		this.cal = cal;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (position >= 0 && position < 7) {
			v = vi.inflate(R.layout.schedule_day_of_week, null);
			TextView day = (TextView) v.findViewById(R.id.schedule_textView1);
			...
			v = vi.inflate(R.layout.schedule_day_view, null);
			FrameLayout today = (FrameLayout) v.findViewById(R.id.schedule_today_frame);
			...
			TextView dayTV = (TextView) v.findViewById(R.id.schedule_textView1);

			RelativeLayout rl = (RelativeLayout) v.findViewById(R.id.schedule_rl);
			ImageView iv = (ImageView) v.findViewById(R.id.schedule_imageView1);
			ImageView blue = (ImageView) v.findViewById(R.id.schedule_imageView2);
			ImageView purple = (ImageView) v.findViewById(R.id.schedule_imageView3);
			ImageView green = (ImageView) v.findViewById(R.id.schedule_imageView4);
			ImageView orange = (ImageView) v.findViewById(R.id.schedule_imageView5);
			ImageView red = (ImageView) v.findViewById(R.id.schedule_imageView6);
