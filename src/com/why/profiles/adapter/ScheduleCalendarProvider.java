...
public class ScheduleCalendarProvider extends ContentProvider {

	private static final String DATABASE_NAME = "Calendar";
	private static final String EVENTS_TABLE = "events";
	private static final int DATABASE_VERSION = 4;
	private static final String AUTHORITY = "com.why.profiles.adapter.schedulecalendarprovider";
	...
	private static class DatabaseHelper extends SQLiteOpenHelper {
		...
		private void createTables(SQLiteDatabase db) {
			db.execSQL("CREATE TABLE " + EVENTS_TABLE + "(" + ID
					...
					+ " TEXT, " + LOCATION + " TEXT, " + DESCRIPTION
					+ " TEXT, " + START + " INTEGER, " + END + " INTEGER, "
					+ START_DAY + " INTEGER, " + END_DAY + " INTEGER, " + COLOR
					+ " INTEGER);");
		}
	}
