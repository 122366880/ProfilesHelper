...
import com.why.profiles.adapter.ScheduleCalendarProvider;
	...
	private class GetEvents extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			Cursor c = context.getContentResolver().query(
					ScheduleCalendarProvider.CONTENT_URI,
					new String[] { ScheduleCalendarProvider.ID, ScheduleCalendarProvider.EVENT,
							ScheduleCalendarProvider.DESCRIPTION,
							ScheduleCalendarProvider.LOCATION, ScheduleCalendarProvider.START,
							ScheduleCalendarProvider.END, ScheduleCalendarProvider.COLOR },
					"?>=" + ScheduleCalendarProvider.START_DAY + " AND "
							+ ScheduleCalendarProvider.END_DAY + ">=?",
