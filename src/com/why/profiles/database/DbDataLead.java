...
public class DbDataLead implements DbService {
	...
	@Override
	public boolean addLoginlist(ContentValues values,String listname) {
		// TODO Auto-generated method stub
		boolean flag = false;
		SQLiteDatabase database = null;
		long id = -1;
	...
	@Override
	public boolean updateLogintag(ContentValues values, String whereClause,
			String[] whereArgs,String listname) {
		boolean flag = false;
		SQLiteDatabase database = null;
		int count = 0;// 影响数据库的行数
	...
	@Override
	public boolean updateLoginName(ContentValues values, String whereClause,
			String[] whereArgs,String listname) {
		boolean flag = false;
		SQLiteDatabase database = null;
		int count = 0;// 影响数据库的行数
	...
	public ArrayList<HashMap<String, Object>> listListMaps(String selection,
		...
		try {
			database = helper.getReadableDatabase();
			cursor = database.query(false, listname, null, selection,
					selectionArgs, null, null, null, null);
			int cols_len = cursor.getColumnCount();
			while (cursor.moveToNext()) {
